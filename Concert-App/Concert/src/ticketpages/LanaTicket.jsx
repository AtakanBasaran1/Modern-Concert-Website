...
import '../ticketpages/lanaticket.css';
...
function LanaTicket() {
    ...
    return (
        <div className='LanaTicketPage'>
            <h1>LANA DEL REY KONSER SEÇİMİ</h1>
            ...
            <img className='lana-ti' src={lana2} alt="Lana Del Rey" />
        </div>
    );
}

export default LanaTicket;
